(function($, win) {
    $.fn.wrpage = function(options) {
        ...
        function init(size, cur) {
            ...
            //头
            if (cur <= 1) {
                _html += '<span class="wrpage wr_pagefirst"><i class="icon iconfont icon-arrowleft"></i></span>'
            } else {
                _html +=
                    '<a href="javascript:;" class="wrpage wr_pagepre"><i class="icon iconfont icon-arrowleft"></i></a>'
            }
            //中间
            if (cur < 5) {
            ...
            if (cur >= size) {
                _html +=
                    '<span href="javascript:;" class="wrpage wr_pagenext"><i class="icon iconfont icon-arrowright"></i></span>'
            } else {
                _html +=
                    '<a href="javascript:;" class="wrpage wr_pagenext"><i class="icon iconfont icon-arrowright"></i></a>'
            }
            em.append(_html)
        }
