...
class Compile
{
    ...
    public function __construct($template, $compileFile, $config) {
        ...
        // 系统设置变量解析
        $this->T_R[] = "<?php fanyi(\$this->value['\\1']); ?>";
        //数据分类标签匹配
        ...
        //首页推荐分类名称标签解析
        $this->T_R[] = "<?php  \$vodtypes=(array)\$this->value['数据分类'];  \$shuzua=\$vodtypes['\\1'];fanyi(\$shuzua['name']); ?>";
        ...
        //首页推荐视频数组标签解析
        $this->T_R[] = "<?php  \$VideoType=\\1;    \$Count=\\2;\$MYSQLVODS = json_decode(file_get_contents('./JCSQL/Home/'.\$VideoType.'.txt'),true); for (\$x=0; \$x<=\$Count-1; \$x++) { if(".$config['WebRandIndex']."){\$randindex = rand(0,200);}else{\$randindex = \$x;};  \$MYSQLVOD=\$MYSQLVODS[\$randindex];  ?>";
        $this->T_R[] = "<?php  } ?>";
        $this->T_R[] = "<?php 	fanyi(\$MYSQLVOD['d_name']);  ?>";
        ...
        $this->T_R[] = "<?php 	fanyi(\$IeUrls['IeUrlName']) ?>";
        //视频分类数组标签匹配
        ...
        //视频分类数组标签解析
        $this->T_R[] = "<?php  fanyi(\$this->value['VideoTypeName']); ?>";
        ...
        $this->T_R[] = "<?php  } ?>";
        $this->T_R[] = "<?php 	fanyi(\$MYSQLVODs['d_name']) ?>";
        ...
        //小说分类数组标签解析
        $this->T_R[] = "<?php  fanyi(\$this->value['BookTypeName']); ?>";
        ...
        $this->T_R[] = "<?php  } ?>";
        $this->T_R[] = "<?php 	fanyi(\$MYSQLVODs['a_name']) ?>";
        ...
        //套图分类数组标签解析
        $this->T_R[] = "<?php  fanyi(\$this->value['PicTypeName']); ?>";
        ...
        //直播分类数组标签解析
        $this->T_R[] = "<?php  fanyi(\$this->value['LiveTypeName']); ?>";
        ...
        //BT分类数组标签解析
        $this->T_R[] = "<?php  fanyi(\$this->value['BtTypeName']); ?>";
        ...
        //视频搜索数组标签解析
        $this->T_R[] = "<?php  fanyi(\$this->value['SearchTypeName']); ?>";
        ...
        //视频标签群数组标签匹配
        $this->T_P[] = "#\{9CCMS-Tag-List:Count=(.*?)\}#i";
        $this->T_P[] = "#\{\/9CCMS-Tag-List\}#i";
        $this->T_P[] = "#\{9CCMS-Tag-List:Name\}#";
        $this->T_P[] = "#\{9CCMS-Tag-List:Url\}#";
        //视频标签群数组标签解析
        $this->T_R[] = "<?php  
		\$Count=\\1;
		\$data=file('./JCSQL/tag.txt');for (\$x=0; \$x<=\$Count; \$x++) {  ?>";
        $this->T_R[] = "<?php  } ?>";
        $this->T_R[] = "<?php 	echo fanyi( \$data[\$x]) ?>";
        $this->T_R[] = "<?php 	echo \$Host1.'video_search'.\$Host2.\$data[\$x].\$Host3.'1'.\$Host4; ?>";

        //公告数组匹配
        $this->T_P[] = "#\{9CCMS-GongGao-List\}#i";
        $this->T_P[] = "#\{\/9CCMS-GongGao-List\}#i";
        $this->T_P[] = "#\{9CCMS-GongGao-List:Content\}#";
        $this->T_P[] = "#\{9CCMS-GongGao-List:Url\}#";
        $this->T_P[] = "#\{9CCMS-GongGao-List:Pic\}#";
        //公告数组解析
        $this->T_R[] = "<?php  
		\$data=json_decode(file_get_contents('./Plug/Plug_Gonggao/Plug_data/AdminGonggao.php'),true); if((int)\$data['WebGongaoOpen']){ ?>";
        $this->T_R[] = "<?php  } ?>";
        $this->T_R[] = "<?php 	echo fanyi(\$data['WebGongao']) ?>";
        $this->T_R[] = "<?php 	echo  \$data['WebGonggaoApp'] ?>";
        $this->T_R[] = "<?php 	echo  \$data['WebGonggaoImg'] ?>";
