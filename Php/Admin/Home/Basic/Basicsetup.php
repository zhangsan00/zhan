...
<?php
/***修改系统设置数据库***/
if (isset($_POST['submit'])  && isset($_POST['WebMobanPC']) && isset($_POST['WebMobanWAP'])  && isset($_POST['WebTitle'])  && isset($_POST['WebKeywords']) && isset($_POST['WebDescription']) && isset($_POST['WebLogo'])) {
