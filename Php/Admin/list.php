...
$MODULE_LEFT3 = $PATH_SELF[sizeof($PATH_SELF) - 3];
if (isset($plug_menu))$plugactive = in_array(str_replace('Plug_','',$MODULE_LEFT3),array_column($plug_menu,'key'));
    ...
    <div class="tpl-left-nav-list">
        <ul class="tpl-left-nav-menu">
            ...
            <?php if (isset($plug_menu)){?>
                <li class="tpl-left-nav-item">
                    <a href="javascript:;"
                       class="nav-link tpl-left-nav-link-list <?php echo $plugactive ? 'active' : '' ?>">
                        <i class="am-icon-skyatlas"></i>
                        <span>扩展管理</span>
                        <i class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right <?php echo $plugactive  ?'':'tpl-left-nav-more-ico-rotate'?>"></i>
                    </a>

                        <ul class="tpl-left-nav-sub-menu  <?php echo $plugactive  ? 'active' : '' ?>">
                            <?php foreach ($plug_menu as $menu){?>
                            <li>
                                <a href="./?Php=<?php echo '/Plug/Plug_'.$menu['key'].'/Plug_admin/index.php'?>" class="<?php echo $MODULE == $menu['key'] ? 'active' : '' ?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span><?php echo $menu['adminName']?></span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>
                            </li>
                            <?php }?>
