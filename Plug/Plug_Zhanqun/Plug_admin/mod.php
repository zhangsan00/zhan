...
foreach ($Templates as $name) {
	 if(strpos($name,'.') !==false || strpos($name,'-') !==false ){
		...
		$bakpc[] =$name;
		 ...
		 $WebMobanPC='<option value="'.$WebMobanPC.'">'.$WebMobanPC.'</option>';

		 $WebMobanWAP='<option value="'.$WebMobanWAP.'">'.$WebMobanWAP.'</option>';
...
?>								
                           ...
                           <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" value="<?php echo $WebDomain;?>" name="WebDomain" placeholder="网站域名不带前缀与带前缀为两个站点">
                                    </div>
                                </div>							
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button type="name" name="submit" class="am-btn am-btn-primary">修改</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
alert("恭喜修改成功！"); 
window.location.href="?Php=Plug/Plug_Zhanqun/Plug_admin/mod.php&Id=<?php echo $Id;?>" 
